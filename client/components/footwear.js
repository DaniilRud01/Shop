            ...
            <div className="left">
              <div className="i-menu-catalog">
                ...
                <ul className="maincatalog-list-2">
                  ...
                  <li>
                    <Link to="#">Для новорожденных</Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to="#">Аксессуары для обуви</Link>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="i-main-banners-slider-v1 row">
                ...
                <div className="row j-ajax-carousel-wrapper">
                  <div className=" i-slider-gallery j-slider-gallery">
                    <h3 className="c-h1 title">Женская</h3>
                    <div className="item-product-slider">
                        ...
                        <Slider {...TwoSliderssettings}>
                          <Link className="product-cart" to="#">
                            <div className="item-img">
                              <img
                                src="https://img1.wbstatic.net/small/new/11650000/11652773.jpg"
                                alt=""
                              />
                            </div>
                      ...
                      <div className=" i-slider-gallery j-slider-gallery">
                        <h3 className="c-h1 title-shoose">Мужская</h3>
                        <div className="item-product-slider">
                          <div className="shoose-product-slider">
                            <Slider {...TwoSliderssettings}>
                              <Link className="product-cart" to="#">
                                <div className="item-img">
                                  <img
                                    src="https://img2.wbstatic.net/small/new/4980000/4987242.jpg"
                                    alt=""
                                  />
                                </div>
                                <div className="item-info">
                      ...
                      <div className=" i-slider-gallery j-slider-gallery">
                        <h3 className="c-h1 title-shoose">Детям</h3>
                        <div className="item-product-slider">
                          <div className="shoose-product-slider">
                            <Slider {...TwoSliderssettings}>
                              <Link className="product-cart" to="#">
                                <div className="item-img">
                                  <img
                                    src="https://img2.wbstatic.net/small/new/3770000/3779478.jpg"
                                    alt=""
                                  />
                                </div>
                                <div className="item-info">
