                ...
                <div className="page-wrap faq-page">
                  ...
                  <div className="faq-contain j-faq-contain">
                    <div className="faq-contain-item  j-faq-contain-item selected">
                      <h1 className="faq-title c-h1">Частые вопросы</h1>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="/faq/rejection-order">Как отменить доставку ?</Link>
                      </h2>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="#">Куда и когда вернутся деньги ?</Link>
                      </h2>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="/faq/order-payment">
                          Почему нельзя оплатить заказ при получении ?
                        </Link>
                      </h2>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="/faq/delivery-of-goods">Когда поступит заказ ?</Link>
                      </h2>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="/faq/delivery-of-goods">Как изменить способ доставки ?</Link>
                      </h2>
                      <h2 className="faq-dropdown-title j-faq-dropdown-title c-h3">
                        <Link to="/faq/delivery-of-goods">Как получить оплаченный заказ ?</Link>
                      </h2>
                    </div>
                  </div>
                </div>
