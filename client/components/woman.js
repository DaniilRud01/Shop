...
import '../style/woman/media.css'
import '../assets/scss/main.scss'
import Footer from './footer'

const Woman = ({ activeBurger }) => {
  const settings = {
    dots: true,
    infinite: true,
    speed: 600,
          ...
          <div className="w-full">
            ...
            <div className="right">
              <div className="i-main-banners-slider-v1">
                <div id="woman-slider" className="slider-section relative" style={{minWidth:"100px"}}>
                  <div id="woman-container" className="container" style={{minWidth:"100px"}}>
                    <div className="slider-item">
                      <Slider {...settings}>
                        <div>
                          <Link to="#">
                ...
                <div className="row j-ajax-carousel-wrapper">
                  <div className=" i-slider-gallery j-slider-gallery">
                    ...
                    <div className="item-product-slider">
                      ...
                      <div className=" i-slider-gallery j-slider-gallery">
                        <h3 className="c-h1 title-shoose">Большие размеры</h3>
                        <div className="item-product-slider">
                          <div className="shoose-product-slider">
                            <Slider {...TwoSliderssettings}>
                              <Link className="product-cart" to="#">
                                <div className="item-img">
                                  <img
                                    src="https://img2.wbstatic.net/small/new/7960000/7960312.jpg"
                                    alt=""
                                  />
                                </div>
                                <div className="item-info">
